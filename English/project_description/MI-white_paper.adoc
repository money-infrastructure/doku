...
(Work in progress - Last update: 2018-03-30)
...
An account can either store a right as a digital bearer instrument or the right will only be documented. In the second case, the owner may need to prove his ownership by other means.

By default, rights are stored as _digital barer instruments_. This means that the right is inextricably linked to unique signed data and only the owner of that data can in fact and legally transfer or assert such right. This applies, for example to the money accounts provided by the co-op money infrastructure.
...
In order to smash this Gordian knot in the area of trade, legal standards and autonomous legal enforcement are introduced in the money infrastructure.
