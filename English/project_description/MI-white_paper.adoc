...
* It is developed for classical currencies and converts, for example, euros into _crypto central bank euros_, also known as digital cash, positive money, secure money, sovereign money or Vollgeld.
...
* It promotes fair trade and sustainable business practices in a very efficient and effective way.
...
Within the money infrastructure, companies can draw attention to their goods and services by providing:

 * good value for money,
 * relevant information and
 * taking responsibility for the goods, services and information provided.

Based on these criteria and data from the processing of contracts, an index is calculated showing the ranking in the list of products and services on the sales platform.
