...
(Work in progress - Last update: 2018-03-07)
...
* It is developed for classical currencies and converts, for example, euros into crypto central bank euros (digital cash, positive money, Vollgeld).
...
Banknotes securitize money, current accounts book the money, and the _Co-op Money Infrastructure_ proves and provides ownership of central bank money on cryptographically protected accounts that are self-administered by the users. The infrastructure is not meant to create new money, but creates _digital bearer instruments_ for existing money.
...
The _Co-op Money Infrastructure_ is decentralized in three ways:
