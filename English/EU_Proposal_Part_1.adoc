...
* *Legal consensus mechanism* for immutable agreements for the Internet of value. Unlike the unimaginable energy consumption that Bitcoin requires, this mechanism does not consume energy.
* *Recommended, standardized and balanced contracts (RSB contracts)* for easy handling of complex and difficult tasks.
...
==== 3.1.1 Research work package

===== 3.1.1.1 Deliverable: Evaluation of available wallets
...
===== 3.1.1.2 Deliverable: Evaluation of cryptographic methods

In the area of cryptocurrencies various cryptographic methods are used. This work package will analyze the existing methods for use in NMI and decide which method to use.


==== 3.1.2 Software development work packages

===== 3.1.2.1 Specification of client applications

====== 3.1.2.1.1 Business and Organization Users Client App

====== 3.1.2.1.2 Private User Client App

====== 3.1.2.1.3 Mobile Client App

====== 3.1.2.1.4 Bank Client App

===== 3.1.2.2 Development of client applications

====== 3.1.2.2.1 Business and Organization Users Client App

====== 3.1.2.2.2 Private User Client App

====== 3.1.2.2.3 Mobile Client App

====== 3.1.2.2.4 Bank Client App
