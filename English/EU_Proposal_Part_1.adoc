...
A user can use the NMI as a generalized accounting system from which to generate reports for any accounting standard.
...
===== Deliverable: Persistent storage strategy
...
==== 3.1.2 Server layer software development work packages
...
==== 3.1.3 Client layer development work packages

===== Specification of client applications

. Business and Organization Users Client App

. Private User Client App
