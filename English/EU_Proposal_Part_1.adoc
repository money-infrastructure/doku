...
*Arne, Monetative and possibly the two Partner-Organisations*
...
* Include a business plan where relevant. *Arne + Jutta*

* As relevant, include information on how the participants will manage the research data generated and/or collected during the project, in particular addressing the following issues: *Arne + IT-Team*
